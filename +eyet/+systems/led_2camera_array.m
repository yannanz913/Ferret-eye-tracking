function [L,C] = led_2camera_array(P, R, mag, scale)
...
% Example:
%   E = [ 1 2 1];
%   pupil = [ 0.01 0.2 0.2 ]; % pupil thickness, width, heighth
%   pupil_origin = [1 0 0];
%   [L,C] = eyet.led_2camera_array([10;0;0],[0 0 0],250,1);
%   figure;
%   eyet.plot.system(E,C,L,pupil,pupil_origin);
%   [im,cmap,intensity] = eyet.cameraview(C,E,L,pupil,pupil_origin);
%   figure;
...
Lo = [ [0;-10;-10] [0;-10;-5] [0;-10;7.5] [0;-5;0] ...
 	[0;10;10] [0;10;5] ];
