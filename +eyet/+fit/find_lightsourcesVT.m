function [L_1 L_2] = find_lightsourcesVT(C, xy_pt11, xy_pt12, xy_pt21, xy_pt22, radii, marble_center,rotation)
...
[pixel_pt11,v_in_11] = C(1).camerapts2worldvectors(xy_pt11');
[pixel_pt12,v_in_12] = C(1).camerapts2worldvectors(xy_pt12');
[pixel_pt21,v_in_21] = C(2).camerapts2worldvectors(xy_pt21');
[pixel_pt22,v_in_22] = C(2).camerapts2worldvectors(xy_pt22');
...
[i_11,az_11,el_11] = marble.vector_on_ellipsoid(pixel_pt11,pixel_pt11+0.1*v_in_11); % left glint in C(1)
[i_12,az_12,el_12] = marble.vector_on_ellipsoid(pixel_pt12,pixel_pt12+0.1*v_in_12); % right glint in C(1)
[i_21,az_21,el_21] = marble.vector_on_ellipsoid(pixel_pt21,pixel_pt21+0.1*v_in_21); % left glint in C(2)
[i_22,az_22,el_22] = marble.vector_on_ellipsoid(pixel_pt22,pixel_pt22+0.1*v_in_22); % right glint in C(2)  
