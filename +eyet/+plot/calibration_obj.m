function h = calibration_obj(varargin)
% eyet.plot.calibration_obj - plot the calibration object in the current axes
%
% h = eyet.calibration_obj()
%
